...
## Color: Color of the cards. 
### U = Blue, G = Green, B = Black, W = White, R = Red
## Rarity: Rarity of the cards; dictates chances of earning the card
### C = Common, U = Uncommon, R = Rare, M = Mythic
## GPWR: Win Rate when Maindecked
## OHWR: Win Rate in Opening Hand
## GIHWR: Win Rate in Hand (Opener or Drawn)
